...
def newTCPServerThread(connectionSocket, addr):
    # addr[0]: IP Address, addr[1]: Port #
...
while True:
    ...
    newServerThread = threading.Thread(target=newTCPServerThread, args=[connectionSocket, addr])
